...
vex::vision::signature BLUEY = vex::vision::signature (3, -1839, -1351, -1595, 6997, 8457, 7727, 3, 0);
...
vex::vision Vision = vex::vision (vex::PORT5, 50, YELLOWY, REDY, BLUEY, SIG_4, SIG_5, SIG_6, SIG_7);
