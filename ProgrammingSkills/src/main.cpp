...
/*
Up aBRow      Movement speed higher
Down aBRow    Movement speed lower
Left aBRow    Toggles intake on and off
Right aBRow   Toggles intake direction
...
void pre_auton(void) {
  ...
  LimitSwitch.pressed([]() { Catapult.stop(); intakeAllowed = 1;});
  // Calibrate();
...
void usercontrol(void) {
  ...
  //   Catapult.spinFor(fwd, 20, rev, false);
  // }
  // Boost.set(false);
  FL.setVelocity(100, pct);
  FR.setVelocity(100, pct);
